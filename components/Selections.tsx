        ...
        <div className='container overflow-x-hidden'>
          ...
          <div className='opacity-0 translate-y-20 md:w-[600px] lg:w-[900px] mb-6 pb-4 rounded-xl p-4 shadow-xl bg-gray-100 mx-auto justify-center md:ml-[100px] lg:mx-auto' id="jordan">
            ...
            <div className='flex flex-col md:flex-row items-center'>
              ...
              <img src="/jordan-1-red.webp" alt="jordan-1-spiderman" className='md:w-[300px] md:h-[150px] lg:w-[500px] lg:h-[250px] mt-4 md:mt-0 md:ml-4' />
            </div>
            <div className='flex flex-col md:flex-row m-3 justify-between items-center p-3'>
              <button className='bg-gray-800 rounded-md p-3 text-white mb-3 md:mb-0'>Explore More</button>
              <p className='font-bold text-lg text-center md:text-right md:ml-auto'>Nike Air Jordan 1 Retro High OG</p>
            </div>
          </div>
