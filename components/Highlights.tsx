...
const Highlights = () => {
  return (
    <div className='flex justify-center my-3 lg:my-[200px] py-3'>
        <div>
            <h1 className='text-3xl font-bold text-gray-900 mx-auto mb-2 text-center p-3' >Popular 2024</h1>
                    ...
                    {popItems.map((item)=>(
                        <li key={item.title} className='px-2'>
                            <div className='mt-3 w-full h-64 tilt-container'>
                                ...
                                <a href="">
                                    <img src={item.image} className='rounded-xl object-cover h-full w-full'/>
                                </a>
                            </div>
                        </li>
                    ))}
